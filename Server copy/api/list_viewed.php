...
if (isset($_SESSION["username"])) {
    ...
    while($row = mysqli_fetch_array($res)){
        array_push($data["data"],array("id"=>$row["id_youtube"],"create_time"=>$row["create_time"],"image"=>"https://i.ytimg.com/vi/".$row["id_youtube"]."/hqdefault.jpg","author"=>$row["author"],"chanel_id"=>"https://www.youtube.com/channel/".$row["author_id"],"video_name"=>$row["video_name"]));
    }

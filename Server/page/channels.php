...
<head>
    <meta charset="UTF-8" />
    <title>Yotube sync - Các kênh đã chặn truy cập</title>
...
<body>
    ...
    <div class="container">
        <div class="row position-relative">
            <div class="mx-auto col-8 p-4 rounded border mt-4">
                ...
                <h6 class="text-center metal-title-small">Danh sách các kênh bị chặn</h6>
    ...
    <script src="/assets/js/channels.js?v=2"></script>
</body>
